  			...
  			<div class="card-body ">
  			    <form action="addExpense" method="post">
      				<div class="form-group" style="font-size: 20px;">
       					 ...
       					 <input type="text" class="form-control" name="expenseAmount" placeholder="Enter Expense Amount" aria-label="Username" aria-describedby="basic-addon1">		 
			        </div>
         			...
         			<input type="date" name="expenseDate" placeholder="Enter Date">
      				</div>
