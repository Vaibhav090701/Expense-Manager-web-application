  ...
  <div class="card">
    ...
    <form action="addIncome" method="post" >
      <div class="form-group " style="font-size: 20px;">
        ...
        <input type="text" class="form-control" name="incomeAmount" placeholder="Income" aria-label="Enter Income Amount" aria-describedby="basic-addon1">
        
      </div>
      <div class="form-group" style="font-size: 20px;">
        <label for="category">Category:</label>
        <br>
        <select name="incomecategory" style="width: 100%;">
